  ...
  const onClick = (e, index) => {
    setSelected((selected) =>
      selected.includes(nfts[index].mint)
        ? selected.filter(
            (n) => n !== selected[selected.indexOf(nfts[index].mint)]
          )
        : [...selected, nfts[index].mint]
    );
  };
    ...
    <div className="BulkMain">
      ...
      <div className="BulkContainer">
        <div className="BulkNfts">
          ...
          {allTokens.length === 0 ? (
            <Button className="maxTokens" onClick={clickMaxTokens}>
              Select All
            </Button>
          ) : (
            <Button className="maxTokens" onClick={unclickMaxTokens}>
              Deselect All
            </Button>
          )}
          <Grid
        ...
        <div className="BulkPurchase">
          ...
          {!isLoading ? (
            <Button
              ...
              disabled={
                !publicKey ||
                (selected.length === 0 && allTokens.length === 0) ||
                !receiver
              }
            >
              Send NFTs in {txTokenList.length} txs
            </Button>
          ) : (
          ...
          <br></br>
          <Button className="refresh" variant="contained" onClick={refreshPage}>
            Refresh
